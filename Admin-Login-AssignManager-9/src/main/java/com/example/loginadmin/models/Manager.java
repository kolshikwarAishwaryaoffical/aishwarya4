...
//	@Size(min=3,message="Role should have atleast 3 characters")
	...
	public Manager(@NotNull(message = "managerId should not be empty") String managerId,
			...
			@Size(min = 10, message = "Mobile neumber should have 10 digits") String mobileNumber, String gender,
			LocalDate dateOfBirth, String address, String city, String state, Long pinCode, String country) {
		super();
		this.managerId = managerId;
		this.firstName = firstName;
		this.lastName = lastName;
