...
//	@Pattern(regexp="^[0-9]{10}$",message="enter 10-digit mobile number")	
	...
	public Employee(String employeeId, String firstName, String lastName, @Email String emailId,
			...
			String role, @Size(min = 10, message = "Mobile neumber should have 10 digits") String mobileNumber,
			String gender, LocalDate dateOfBirth, String address, String city, String state, Long pinCode,
